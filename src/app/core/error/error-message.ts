...
@Component({
  ...
  template: `
    @if (errorService.isErrorVisible() && error) {
      <div id="alert-additional-content-2" class="alert-container p-4 mb-4 text-sm text-fg-danger-strong bg-danger-soft border border-danger-subtle" role="alert">
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            ...
            <h3 class="semi-bold-txt">There has been an error:</h3>
          </div>
